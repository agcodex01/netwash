...
@section('title','Laundry | Customers')
          ...
          <div class="row">
             ...
             <div class="col-xl-6 col-md-6">
              ...
              <div class="col-xl-6 col-md-6 text-right">
                  <a href="/admin/customers/create" class="btn btn-info "> <i class="fa fa-plus"></i> Add Customer</a>
              </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover mb-0 text-center">
                ...
                <thead class="thead-dark">
                  <tr >
                    <th class="th-sm"><a>ID<i class="fas fa-sort ml-1"></i></a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/laundry/customers/{{$customer->id}}"><i class="fa fa-eye text-primary" data-toggle="tooltip" data-placement="top" title="view user details"></i></a></td>
                        <td><a class="">
                            <i class="fa fa-trash-alt text-danger"  data-toggle="tooltip" data-placement="top" title="delete user" 
        ...
        <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="/laundry/customer/delete" method="POST">
