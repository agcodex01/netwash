      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
          ...
          <div class="card card-cascade cascading-admin-card">
            ...
            <!-- Card Data -->
            <div class="admin-up">
              <a type="button" href="/laundry/customers">
              <i class="far fa-user primary-color mr-3 z-depth-2"></i>
            </a>
              <div class="data">
                <p class="text-uppercase">Customers</p>
                <h4 class="font-weight-bold dark-grey-text">{{$data[0]->customers}}</h4>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
          ...
          <div class="card card-cascade cascading-admin-card">
            ...
            <!-- Card Data -->
            <div class="admin-up">
              <a href="{{route('laundry.order.index')}}">
                  <i class="fas fa-users warning-color mr-3 z-depth-2"></i>
              </a>
              <div class="data">
                <p class="text-uppercase">Orders</p>
                <h4 class="font-weight-bold dark-grey-text">{{$data[0]->orders}}</h4>
              </div>
            </div>
